...
BackFrame.Size = UDim2.new(0.7, 0, 0.82, 0)
...
FramePadding.PaddingLeft = UDim.new(0, 6)
FramePadding.PaddingRight = UDim.new(0, 10)
FramePadding.PaddingTop = UDim.new(0, 6)
...
PageLeft.BorderSizePixel = 0; PageLeft.AnchorPoint = Vector2.new(0, 0.5); PageLeft.Position = UDim2.new(0.28, 0, 0.5, 0)
...
PageLabel.Size = UDim2.new(0.25, 0, 0.85, 0)
...
PageRight.BorderSizePixel = 0; PageRight.AnchorPoint = Vector2.new(1, 0.5); PageRight.Position = UDim2.new(0.72, 0, 0.5, 0)
...
EmoteName.Size = UDim2.new(0.7, 0, 0.06, 0)
...
TopBar.BackgroundTransparency = 1; TopBar.Size = UDim2.new(1, 0, 0.08, 0)
...
CloseButton.Size = UDim2.new(0.10, 0, 0.9, 0); CloseButton.TextScaled = true; CloseButton.TextColor3 = Color3.new(1, 1, 1)
...
SearchBar.BorderSizePixel = 0; SearchBar.AnchorPoint = Vector2.new(0, 0.5); SearchBar.Position = UDim2.new(0.11, 0, 0.5, 0)
...
ModeButton.BorderSizePixel = 0; ModeButton.AnchorPoint = Vector2.new(0, 0.5); ModeButton.Position = UDim2.new(0.42, 0, 0.5, 0)
ModeButton.Size = UDim2.new(0.12, 0, 0.9, 0); ModeButton.TextScaled = true; ModeButton.TextColor3 = Color3.new(1, 1, 1)
...
CustomAnimBtn.Size = UDim2.new(0.12, 0, 0.9, 0); CustomAnimBtn.TextScaled = true; CustomAnimBtn.TextColor3 = Color3.new(1, 1, 1)
...
SortButton.Size = UDim2.new(0.14, 0, 0.9, 0); SortButton.TextScaled = true; SortButton.TextColor3 = Color3.new(1, 1, 1)
...
SortFrame.Visible = false; SortFrame.BorderSizePixel = 0; SortFrame.Position = UDim2.new(1, 5, -0.15, 0)
SortFrame.Size = UDim2.new(0.35, 0, 0, 0); SortFrame.AutomaticSize = Enum.AutomaticSize.Y; SortFrame.BackgroundTransparency = 1
...
function refreshGrid()
    ...
    for i = startIdx, endIdx do
        ...
        if item then
            ...
            btn.LayoutOrder = i; Instance.new("UICorner", btn).CornerRadius = UDim.new(0, 8)
            ...
            Favorite.AnchorPoint = Vector2.new(0.5, 0.5); Favorite.Size = UDim2.new(0.35, 0, 0.35, 0); Favorite.Position = UDim2.new(0.88, 0, 0.88, 0)
...
-- Page navigation: type a page number
...
local function openCustomAnimEditor()
    ...
    if not customFrame then
        ...
        customFrame.Size = UDim2.new(0.5, 0, 0.65, 0); customFrame.AnchorPoint = Vector2.new(0.5, 0.5); customFrame.Position = UDim2.new(0.5, 0, 0.5, 0)
        customFrame.ClipsDescendants = true; customFrame.ZIndex = 50
        Instance.new("UICorner", customFrame).CornerRadius = UDim.new(0, 12)

        local titleBar = Instance.new("Frame", customFrame); titleBar.BackgroundTransparency = 1; titleBar.Size = UDim2.new(1, 0, 0, 42); titleBar.ZIndex = 51
        local titleLabel = Instance.new("TextLabel", titleBar); titleLabel.BackgroundTransparency = 1; titleLabel.Size = UDim2.new(0.8, 0, 1, 0); titleLabel.Position = UDim2.fromOffset(12, 0); titleLabel.Font = Enum.Font.GothamBold; titleLabel.Text = "Custom Animation Slots"; titleLabel.TextColor3 = Color3.fromRGB(255, 255, 255); titleLabel.TextSize = 16; titleLabel.TextXAlignment = Enum.TextXAlignment.Left; titleLabel.ZIndex = 52
        local closeBtn = Instance.new("TextButton", titleBar); closeBtn.BackgroundTransparency = 1; closeBtn.Size = UDim2.fromOffset(42, 42); closeBtn.Position = UDim2.new(1, -42, 0, 0); closeBtn.Font = Enum.Font.GothamBold; closeBtn.Text = "X"; closeBtn.TextColor3 = Color3.fromRGB(200, 200, 200); closeBtn.TextSize = 18; closeBtn.ZIndex = 52; closeBtn.MouseButton1Click:Connect(closeCustomAnimEditor)

        local contentArea = Instance.new("Frame", customFrame); contentArea.BackgroundTransparency = 1; contentArea.Position = UDim2.fromOffset(0, 44); contentArea.Size = UDim2.new(1, 0, 1, -44); contentArea.ZIndex = 51; contentArea.ClipsDescendants = true
        ...
        local scrollFrame = Instance.new("ScrollingFrame", slotPage); scrollFrame.BackgroundTransparency = 1; scrollFrame.Position = UDim2.fromOffset(0, 0); scrollFrame.Size = UDim2.new(1, 0, 1, -50); scrollFrame.ScrollBarThickness = 5; scrollFrame.ScrollBarImageColor3 = Color3.fromRGB(100, 100, 100); scrollFrame.CanvasSize = UDim2.fromOffset(0, 0); scrollFrame.AutomaticCanvasSize = Enum.AutomaticSize.Y; scrollFrame.BorderSizePixel = 0; scrollFrame.ZIndex = 53
        local ll = Instance.new("UIListLayout", scrollFrame); ll.Padding = UDim.new(0, 5); ll.SortOrder = Enum.SortOrder.LayoutOrder
        local padUI = Instance.new("UIPadding", scrollFrame); padUI.PaddingLeft = UDim.new(0, 10); padUI.PaddingRight = UDim.new(0, 10); padUI.PaddingTop = UDim.new(0, 5)
        ...
        local pickerTitle = Instance.new("TextLabel", pickerPage); pickerTitle.BackgroundTransparency = 1; pickerTitle.Size = UDim2.new(1, -70, 0, 32); pickerTitle.Position = UDim2.fromOffset(10, 2); pickerTitle.Font = Enum.Font.GothamBold; pickerTitle.Text = "Pick bundle for: idle"; pickerTitle.TextColor3 = Color3.fromRGB(255, 255, 255); pickerTitle.TextSize = 14; pickerTitle.TextXAlignment = Enum.TextXAlignment.Left; pickerTitle.ZIndex = 53
        local pickerBack = Instance.new("TextButton", pickerPage); pickerBack.BackgroundColor3 = Color3.new(0, 0, 0); pickerBack.BackgroundTransparency = 0.3; pickerBack.Size = UDim2.fromOffset(55, 28); pickerBack.Position = UDim2.new(1, -65, 0, 4); pickerBack.Font = Enum.Font.GothamBold; pickerBack.Text = "Back"; pickerBack.TextColor3 = Color3.fromRGB(220, 220, 220); pickerBack.TextSize = 12; pickerBack.BorderSizePixel = 0; pickerBack.ZIndex = 53; Instance.new("UICorner", pickerBack).CornerRadius = UDim.new(0, 6)
        local pickerSearch = Instance.new("TextBox", pickerPage); pickerSearch.BackgroundColor3 = Color3.new(0, 0, 0); pickerSearch.BackgroundTransparency = 0.3; pickerSearch.Position = UDim2.fromOffset(6, 38); pickerSearch.Size = UDim2.new(1, -12, 0, 30); pickerSearch.Font = Enum.Font.Gotham; pickerSearch.PlaceholderText = "Search bundles..."; pickerSearch.PlaceholderColor3 = Color3.fromRGB(100, 100, 100); pickerSearch.Text = ""; pickerSearch.TextColor3 = Color3.fromRGB(255, 255, 255); pickerSearch.TextSize = 13; pickerSearch.ClearTextOnFocus = false; pickerSearch.BorderSizePixel = 0; pickerSearch.ZIndex = 53; Instance.new("UICorner", pickerSearch).CornerRadius = UDim.new(0, 6)
        local pickerScroll = Instance.new("ScrollingFrame", pickerPage); pickerScroll.BackgroundTransparency = 1; pickerScroll.Position = UDim2.fromOffset(0, 74); pickerScroll.Size = UDim2.new(1, 0, 1, -74); pickerScroll.ScrollBarThickness = 5; pickerScroll.ScrollBarImageColor3 = Color3.fromRGB(100, 100, 100); pickerScroll.CanvasSize = UDim2.fromOffset(0, 0); pickerScroll.AutomaticCanvasSize = Enum.AutomaticSize.Y; pickerScroll.BorderSizePixel = 0; pickerScroll.ZIndex = 53
        local pll = Instance.new("UIListLayout", pickerScroll); pll.Padding = UDim.new(0, 3); pll.SortOrder = Enum.SortOrder.LayoutOrder
        ...
        local function populatePickerList(filterTerm)
            ...
            for _, item in ipairs(matches) do
                local btn = Instance.new("TextButton"); btn.BackgroundColor3 = Color3.new(0, 0, 0); btn.BackgroundTransparency = 0.4; btn.Size = UDim2.new(1, -6, 0, 34); btn.Font = Enum.Font.Gotham; btn.Text = "  " .. item.name; btn.TextColor3 = Color3.fromRGB(220, 220, 220); btn.TextSize = 12; btn.TextXAlignment = Enum.TextXAlignment.Left; btn.BorderSizePixel = 0; btn.ZIndex = 54; btn.AutoButtonColor = true; Instance.new("UICorner", btn).CornerRadius = UDim.new(0, 6); btn.Parent = pickerScroll
                btn.MouseButton1Click:Connect(function()
        ...
        for idx, slotName in ipairs(ANIM_SLOT_NAMES) do
            local row = Instance.new("Frame", scrollFrame); row.Name = "Row_" .. slotName; row.BackgroundColor3 = Color3.new(0, 0, 0); row.BackgroundTransparency = 0.4; row.Size = UDim2.new(1, 0, 0, 44); row.LayoutOrder = idx; row.BorderSizePixel = 0; row.ZIndex = 54; Instance.new("UICorner", row).CornerRadius = UDim.new(0, 8)
            local slotLabel = Instance.new("TextLabel", row); slotLabel.BackgroundTransparency = 1; slotLabel.Position = UDim2.fromOffset(10, 0); slotLabel.Size = UDim2.new(0.18, 0, 1, 0); slotLabel.Font = Enum.Font.GothamBold; slotLabel.Text = slotName; slotLabel.TextColor3 = Color3.fromRGB(220, 220, 220); slotLabel.TextSize = 13; slotLabel.TextXAlignment = Enum.TextXAlignment.Left; slotLabel.ZIndex = 55
            local currentLabel = Instance.new("TextLabel", row); currentLabel.Name = "CurrentLabel"; currentLabel.BackgroundTransparency = 1; currentLabel.Position = UDim2.new(0.20, 0, 0, 0); currentLabel.Size = UDim2.new(0.36, 0, 1, 0); currentLabel.Font = Enum.Font.Gotham; currentLabel.Text = "None"; currentLabel.TextColor3 = Color3.fromRGB(150, 150, 150); currentLabel.TextSize = 12; currentLabel.TextTruncate = Enum.TextTruncate.AtEnd; currentLabel.TextXAlignment = Enum.TextXAlignment.Left; currentLabel.ZIndex = 55
            local removeBtn = Instance.new("TextButton", row); removeBtn.Name = "RemoveBtn"; removeBtn.BackgroundColor3 = Color3.fromRGB(180, 50, 50); removeBtn.Position = UDim2.new(0.57, 0, 0.1, 0); removeBtn.Size = UDim2.new(0.18, -2, 0.8, 0); removeBtn.Font = Enum.Font.GothamBold; removeBtn.Text = "X"; removeBtn.TextColor3 = Color3.fromRGB(255, 255, 255); removeBtn.TextSize = 13; removeBtn.BorderSizePixel = 0; removeBtn.ZIndex = 55; Instance.new("UICorner", removeBtn).CornerRadius = UDim.new(0, 6)
        ...
        local bottomBar = Instance.new("Frame", slotPage); bottomBar.BackgroundTransparency = 1; bottomBar.BorderSizePixel = 0; bottomBar.Size = UDim2.new(1, 0, 0, 42); bottomBar.Position = UDim2.new(0, 0, 1, -44); bottomBar.ZIndex = 54
        local bottomLayout = Instance.new("UIListLayout", bottomBar); bottomLayout.FillDirection = Enum.FillDirection.Horizontal; bottomLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center; bottomLayout.VerticalAlignment = Enum.VerticalAlignment.Center; bottomLayout.Padding = UDim.new(0, 12)
        local applyAllBtn = Instance.new("TextButton", bottomBar); applyAllBtn.LayoutOrder = 1; applyAllBtn.BackgroundColor3 = Color3.fromRGB(40, 160, 60); applyAllBtn.Size = UDim2.new(0, 150, 0, 32); applyAllBtn.Font = Enum.Font.GothamBold; applyAllBtn.Text = "Apply All"; applyAllBtn.TextColor3 = Color3.fromRGB(255, 255, 255); applyAllBtn.TextSize = 13; applyAllBtn.BorderSizePixel = 0; applyAllBtn.ZIndex = 55; Instance.new("UICorner", applyAllBtn).CornerRadius = UDim.new(0, 8)
        applyAllBtn.MouseButton1Click:Connect(function() task.spawn(applyAllCustomSlots) end)
        local clearAllBtn = Instance.new("TextButton", bottomBar); clearAllBtn.LayoutOrder = 2; clearAllBtn.BackgroundColor3 = Color3.fromRGB(180, 50, 50); clearAllBtn.Size = UDim2.new(0, 150, 0, 32); clearAllBtn.Font = Enum.Font.GothamBold; clearAllBtn.Text = "Clear All"; clearAllBtn.TextColor3 = Color3.fromRGB(255, 255, 255); clearAllBtn.TextSize = 13; clearAllBtn.BorderSizePixel = 0; clearAllBtn.ZIndex = 55; Instance.new("UICorner", clearAllBtn).CornerRadius = UDim.new(0, 8)
